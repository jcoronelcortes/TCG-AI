...
| --- | --- | --- |
| **Marnie Grimmsnarl** | Bench damage that snipes our developing line, plus chip damage between turns. **And the threat is not the ex.** Marnie's Grimmsnarl ex is 320 HP and **weak to Grass**, so a charged Teal Mask Ogerpon ex on our bench already reads 300–420 against it; what nothing answers is the two abilities no evolution step controls — Froslass's *Freezing Shroud* (20 a round to our whole board, because every body of ours has an ability) and **Munkidori's *Adrena-Brain*, worse because it aims**: 30 counters moved wherever they close a knockout, reloaded every checkup by their own Froslass. | Heal or evolve out of the snipe range; watch the window where a benched body becomes a free prize. So **gust the engine and not the line** — charged Munkidori first, then Froslass, then a bare Munkidori — whenever the rung that outbids it has nothing to protect, which happens **two ways**: their Stage 2 is already answered from our *bench* (an answer that has to be in the active spot is not a reserve), **or their line is carrying no energy at all** — that rung demands a *charged* pre-evolution, so at zero it never fires and the engine is owed the gust by nobody. Three pages, three switches: [the engine before its line](marnie-the-engine-goes-before-its-line-2026-08-16.md), [the energy and not the HP](marnie-the-gust-reads-the-energy-not-the-hp-2026-08-16.md), [the bare line](marnie-the-bare-line-asks-nothing-of-the-reserve-2026-08-16.md). |
