...
| [Night plan, 13 Aug](night-plan-2026-08-13.md) | **The next session, written to run unattended.** All seven questions asked in §0 before anything starts, then no interruption until the morning report. Its axis is the forward-simulation API nothing has ever called — measured while writing the plan: a full rollout to game end costs 0.02 s. Its second block re-asks the seven rules reverted as "neutral" back when the noise floor was ±6.5. §7 is what it does when something fails at 03:00. |
