...
class PuntuacionCtx:
    ...
    _cuerpo_condenado: Any = None
    _dc: Any = None
    _deny_evo_via_boss: Any = None
    _descuadre_matchup: Any = None
    ...
    _gt_plan: Any = None
    _gt_planes: Any = None
    _gt_planes_turno: Any = None
    _gt_prompt_si_no: Any = None
    _gt_quiere_basico: Any = None
    _gt_raiz_en_juego: Any = None
    ...
    _meowth_fetch_ya_en_mano: Any = None
    ...
    _ub_meowth_para_manana: Any = None
