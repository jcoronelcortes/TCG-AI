...
from ptcg.cards.ids import Basic_Grass_Energy, Hydrapple_ex, RETREAT_COST, Teal_Mask_Ogerpon_ex
from ptcg.calc.board import _active_of
from ptcg.calc.energy import _grass_ability_slots, _grass_attach_unit, _retreat_grass_units
from ptcg.calc.damage import _attacker_base_damage, _ko_not_guaranteed, _our_effective_damage
from ptcg.calc.card import prize_count_op
from ptcg.state.zones import ZONE_DECK, ZONE_PRIZE
from ptcg.state.agent_state import AGENT_STATE
from ptcg.cards.ids import FISHING_PRIZES_MIN, FISHING_PROB_MIN
