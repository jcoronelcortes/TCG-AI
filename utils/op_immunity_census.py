...
THE THREE TABLES, and what each one claims:
...
Usage:
    python utils/op_immunity_census.py                # the four buckets
...
def main(argv):
    ...
    print(f"{n_decks} mazos rivales, {total} ids en las tres tablas de inmunidad\n")
    for bucket in ORDEN:
    ...
    if not interes:
        print("Las tres tablas dicen lo que dicen las cartas.")
    else:
