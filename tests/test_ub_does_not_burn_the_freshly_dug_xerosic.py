...
def test_the_protected_lillie_is_not_fodder():
...
def test_a_protected_dawn_is_not_fodder_either():
...
def test_the_surplus_lillie_copy_is_fodder():
...
def test_protecting_the_lillie_itself_the_dawn_is_still_fodder():
