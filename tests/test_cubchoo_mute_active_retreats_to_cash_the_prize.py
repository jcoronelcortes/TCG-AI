...
stays out of the set on purpose: its Myriad Leaf Shower scales with its own
energy, those Grass are investment, and the PASS still stands
(`test_the_veto_still_stands_for_a_charged_ogerpon`).
...
def test_the_veto_still_stands_for_a_charged_ogerpon():
    """registro_004 p47: with a Teal Mask Ogerpon ex in front, the three Grass on it
    ARE its damage (Myriad Leaf Shower scales with its own energy). Retreating
    destroys investment, which is exactly what this control lives on: we PASS."""
